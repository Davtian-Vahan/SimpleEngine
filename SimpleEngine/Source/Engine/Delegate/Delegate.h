...
/*
		This implementation is provided by simco50.
		link: https://github.com/simco50/CppDelegates/blob/master/Delegates.h

		Maybe a custom implementation will be made later on.
